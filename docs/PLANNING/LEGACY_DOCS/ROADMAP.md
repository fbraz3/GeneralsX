...
See `docs/PLANNING/3/PHASE37/README.md` for detailed Phase 37.1 instructions.
...
| `docs/PLANNING/28/PHASE28/CRITICAL_VFS_DISCOVERY.md` | Why VFS failed, why Apply_New_Surface works |
| `docs/PLANNING/3/PHASE30/` | Metal backend architecture |
| `docs/PLANNING/3/PHASE33/` | OpenAL implementation details |
| `docs/PLANNING/3/PHASE35/PROTECTION_INVENTORY.md` | Protection code removal decisions |
...
**Read**: `docs/PLANNING/3/PHASE37/README.md` for detailed instructions
