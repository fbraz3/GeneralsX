...
- `docs/WORKDIR/phases/4/PHASE41/` through `docs/WORKDIR/phases/4/PHASE48/` - Detailed phase planning
- `docs/DEV_BLOG/YYYY-MM-DIARY.md (organized by month)` - Development diary (update after each phase)
- `docs/WORKDIR/support/` - Cross-phase technical reference materials

### Build Instructions

- `docs/ETC/MACOS_BUILD_INSTRUCTIONS.md` - macOS-specific build guide
...
- [ ] Update `docs/DEV_BLOG/YYYY-MM-DIARY.md`
...
4. Update `docs/WORKDIR/lessons/LESSONS_LEARNED.md` with discoveries
