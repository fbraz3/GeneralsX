...
- Added visible README section "Running the game" after "How to download" linking to `docs/HOW_TO_RUN.md`.
- Reviewed and updated `docs/HOW_TO_RUN.md` to recommend `GeneralsZH` and document `GeneralsMD` fallback.
