...
**                             SurfaceClass
**
** This is our surface class, which wraps CORE_IDirect3DSurface8.
**
...
class SurfaceClass : public W3DMPO, public RefCountClass
{
	...
	public:
		...
		SurfaceClass(CORE_IDirect3DSurface8 *d3d_surface);
		...
		CORE_IDirect3DSurface8 *Peek_D3D_Surface(void) { return D3DSurface; }

		// Attaching and detaching a surface pointer
		void	Attach (CORE_IDirect3DSurface8 *surface);
		void	Detach (void);
	...
	private:
		...
		CORE_IDirect3DSurface8 *D3DSurface;
