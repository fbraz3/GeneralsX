...
-- Script para executar comandos no Terminal.app do macOS
-- Uso: runTerminal.sh "comando" [profile]
-- O terminal será fechado automaticamente após a execução do comando
...
on run argv                                                                                     
  if length of argv is equal to 0                                                               
    ...
    -- Adiciona exit para fechar o terminal após execução
    set command to command & "; exit"
  end if                                                                                        
