...
- **BIG Files Reference**: Seand `docs/WORKDIR/support/BIG_FILES_REFERENCE.md`
- **Critical VFS Discovery**: Seand `docs/WORKDIR/support/CRITICAL_VFS_DISCOVERY.md`
- **Lessons Learned**: Seand `docs/WORKDIR/lessons/LESSONS_LEARNED.md`
- **Compatibility Layers**: Seand `docs/WORKDIR/phases/0/PHASE00/COMPATIBILITY_LAYERS.md` (Layer 3)
- **Phase 28.4 Texture Interception**: Seand `docs/WORKDIR/28/PHASE28/README.md`
- **Phase 22.7-23 INI Fixes**: Seand `docs/WORKDIR/22/PHASE22/README.md` and `docs/WORKDIR/23/PHASE23/README.md`
