# GeneralsX modern Windows x64 configure script.
# GeneralsX @build BenderAI 01/04/2026 Configure CMake with modern Windows preset.
...
Write-Host "Configure complete: $Preset"
