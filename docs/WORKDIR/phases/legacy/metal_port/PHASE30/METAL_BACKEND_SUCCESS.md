...
- `docs/WORKDIR/phases/3/PHASE30/METAL_BACKEND_SUCCESS.md` - Metal backend implementation details
- `docs/WORKDIR/support/OPENGL_SUMMARY.md` - OpenGL implementation (deprecated on macOS)
- `docs/DEV_BLOG/YYYY-MM-DIARY.md (organized by month)` - Overall macOS port progress
