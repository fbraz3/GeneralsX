...
#define GENERALS_REG_KEY_BOTTOM GENERALS_REG_KEY_PATH GET_PATH_SEPARATOR()									///< Generals registry key with trailing backslashes
...
#define GENERALS_REG_KEY GENERALS_REG_KEY_TOP GET_PATH_SEPARATOR() GENERALS_REG_KEY_BOTTOM	///< Full Generals registry path
...
#define WOLAPI_REG_KEY_BOTTOM WOLAPI_REG_KEY_PATH GET_PATH_SEPARATOR()											///< WOLAPI registry key with trailing backslashes
...
#define WOLAPI_REG_KEY WOLAPI_REG_KEY_TOP GET_PATH_SEPARATOR() WOLAPI_REG_KEY_BOTTOM				///< Full WOLAPI registry path
...
#define DLL_REG_KEY_BOTTOM DLL_REG_KEY_PATH GET_PATH_SEPARATOR()											///< WOLAPI registry key with trailing backslashes
