...
#define _set_keyname_(k,s,s2,z) (m_keyNames[z].stdKey = k, m_keyNames[z].shifted = s, m_keyNames[z].shifted2 = s2)
	...
	case LANGUAGE_ID_SPANISH:		// not localized
		...
		_set_keyname_(L'\n', L'\n', L'\0', KEY_KPENTER);
		_set_keyname_(LGET_PATH_SEPARATOR(), LGET_PATH_SEPARATOR(), L'\0', KEY_KPSLASH);
		...
		_set_keyname_(LGET_PATH_SEPARATOR(), L'?', L'\0', KEY_SLASH);
		...
		_set_keyname_(LGET_PATH_SEPARATOR(), L'|', L'\0', KEY_BACKSLASH);
	...
	case LANGUAGE_ID_UK:
		...
		_set_keyname_(LGET_PATH_SEPARATOR(), L'|', L'\0', KEY_102);
	...
	case LANGUAGE_ID_GERMAN:
		...
		_set_keyname_(L'5', L'%', L'\0', KEY_5);
		_set_keyname_(L'6', L'&', L'\0', KEY_6);
		_set_keyname_(L'7', LGET_PATH_SEPARATOR(), L'{', KEY_7);
		...
		_set_keyname_(0x00DF, L'?', LGET_PATH_SEPARATOR(), KEY_MINUS);				//ß (sharp s)
	...
	case LANGUAGE_ID_FRENCH:
		...
		_set_keyname_(L'_', L'8', LGET_PATH_SEPARATOR(), KEY_8);
		_set_keyname_(0x00E7, L'9', L'\0', KEY_9);	//ç (cedilla)
		_set_keyname_(0x00E0, L'0', L'@', KEY_0);	//à (grave)

		_set_keyname_(L';', L'.', L'\0', KEY_COMMA);
		_set_keyname_(L':', LGET_PATH_SEPARATOR(), L'\0', KEY_PERIOD);
	...
	case LANGUAGE_ID_ITALIAN:
		...
		_set_keyname_(L'5', L'%', L'\0', KEY_5);
		_set_keyname_(L'6', L'&', L'\0', KEY_6);
		_set_keyname_(L'7', LGET_PATH_SEPARATOR(), L'\0', KEY_7);
		_set_keyname_(L'8', L'(', L'\0', KEY_8);
		_set_keyname_(L'9', L')', L'\0', KEY_9);
		_set_keyname_(L'0', L'=', L'\0', KEY_0);
		...
		_set_keyname_(LGET_PATH_SEPARATOR(), L'|', L'\0', KEY_TICK);
