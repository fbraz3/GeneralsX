...
**References**:
- `docs/WORKDIR/phases/3/PHASE34/PHASE34_3_METAL_CRASH_FIXED.md` - s_passDesc bug discovery
- `docs/WORKDIR/lessons/LESSONS_LEARNED.md` - Global state anti-patterns
