...
- **Build System Guide**: See `docs/WORKDIR/phases/0/PHASE00/BUILD_TARGETS.md`
- **Setup Guide**: See `docs/WORKDIR/phases/0/PHASE00/SETUP_ENVIRONMENT.md`
- **Asset System**: See `docs/WORKDIR/phases/0/PHASE00/ASSET_SYSTEM.md`
- **Platform Decisions**: See `docs/WORKDIR/phases/0/PHASE00/PLATFORM_PRESETS.md`
