...
1. **Read**: `docs/WORKDIR/phases/0/PHASE00/README.md` - Project overview
2. **Read**: `docs/WORKDIR/phases/0/PHASE00/CRITICAL_LESSONS.md` - Critical patterns to remember
3. **Review**: `docs/WORKDIR/phases/0/PHASE00/COMPATIBILITY_LAYERS.md` - Architecture
4. **Start**: `docs/WORKDIR/phases/0/PHASE01/README.md` - Begin PHASE01 Implementation
...
- **Project Overview**: `docs/WORKDIR/phases/0/PHASE00/README.md`
- **Troubleshooting**: `.github/instructions/project.instructions.md`
- **Asset System**: `docs/WORKDIR/phases/0/PHASE00/ASSET_SYSTEM.md`
...
**For questions**:
- Check `docs/WORKDIR/lessons/LESSONS_LEARNED.md` for common problems
- Review `docs/DEV_BLOG/YYYY-MM-DIARY.md (organized by month)` for development history
