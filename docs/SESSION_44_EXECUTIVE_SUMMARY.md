...
1. **Documentation**: Read `docs/PHASE40/README.md` (complete it takes 30 minutes)
...
- Update `docs/MACOS_PORT_DIARY.md` at end of each session
...
- Consult detailed guides: `docs/PHASE40/README.md`
- Check session notes: `docs/PHASE40/SESSION_SUMMARY.md`
- Review references: `docs/PHASE40/README.md` references section
...
2. Reading `docs/PHASE40/README.md` Week 1 section
