...
UpdateSleepTime ObjectDefectionHelper::update()
{
	...
	{
		Bool lastPhase = ( ((Int)(uintptr_t)m_defectionDetectionFlashPhase) & 1 );// were we in a flashy phase last frame?
		...
		Bool thisPhase = ( ((Int)(uintptr_t)m_defectionDetectionFlashPhase) & 1 );// are we in a flashy phase this frame?
