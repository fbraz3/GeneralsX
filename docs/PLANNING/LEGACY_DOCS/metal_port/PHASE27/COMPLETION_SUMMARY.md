...
**Files Modified**:
- `GeneralsMD/Code/Libraries/Source/WWVegas/WW3D2/dx8wrapper.h/cpp`
- `docs/PLANNING/27/PHASE27/OPENGL_BACKPORT_GUIDE.md`
...
- `docs/PLANNING/27/PHASE27/PERFORMANCE_BASELINE.md` (NEW - 280+ lines)
- `docs/PLANNING/27/PHASE27/TEXTURE_LOADING_DESIGN.md` (NEW)
...
- `docs/PLANNING/27/PHASE27/OPENGL_BACKPORT_GUIDE.md` - Step-by-step backport instructions
- `docs/PLANNING/27/PHASE27/PERFORMANCE_BASELINE.md` - Performance metrics and analysis
