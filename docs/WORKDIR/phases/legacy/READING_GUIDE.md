...
📖 docs/WORKDIR/lessons/LESSONS_LEARNED.md - Past bug solutions
📖 docs/WORKDIR/support/CRITICAL_FIXES.md - Emergency fixes
```
...
- Status: `docs/DEV_BLOG/YYYY-MM-DIARY.md (organized by month)`
