...
void PeerThreadClass::Thread_Function()
{
	try {
		...
		const char *allKeys = "\\pid_\\mapname\\gamever\\gamename" \
			GET_PATH_SEPARATOR() EXECRC_STR GET_PATH_SEPARATOR() INICRC_STR \
			GET_PATH_SEPARATOR() PW_STR GET_PATH_SEPARATOR() OBS_STR GET_PATH_SEPARATOR() USE_STATS_STR GET_PATH_SEPARATOR() LADIP_STR GET_PATH_SEPARATOR() LADPORT_STR \
			GET_PATH_SEPARATOR() PINGSTR_STR GET_PATH_SEPARATOR() NUMOBS_STR \
			GET_PATH_SEPARATOR() NUMPLAYER_STR GET_PATH_SEPARATOR() MAXPLAYER_STR \
			GET_PATH_SEPARATOR() NAME__STR "_" GET_PATH_SEPARATOR() WINS__STR "_" GET_PATH_SEPARATOR() LOSSES__STR "_" GET_PATH_SEPARATOR() FACTION__STR "_" GET_PATH_SEPARATOR() COLOR__STR "_";
		*/
