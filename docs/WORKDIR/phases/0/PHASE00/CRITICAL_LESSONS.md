...
- **Full VFS discovery**: `docs/WORKDIR/support/CRITICAL_VFS_DISCOVERY.md`
- **All lessons learned**: `docs/WORKDIR/lessons/LESSONS_LEARNED.md`
- **Phase 28.4 details**: `docs/WORKDIR/28/PHASE28/README.md`
- **Phase 33.9 details**: `docs/WORKDIR/phases/3/PHASE33/README.md`
- **Phase 35.6 details**: `docs/WORKDIR/phases/3/PHASE35/README.md`
- **Phase 34.3 details**: `docs/WORKDIR/phases/3/PHASE34/README.md`
- **Phase 48 details**: `docs/WORKDIR/phases/4/PHASE48/README.md`
