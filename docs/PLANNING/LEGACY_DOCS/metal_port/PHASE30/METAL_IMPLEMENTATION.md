...
- Update `docs/DEV_BLOG/YYYY-MM-DIARY.md (organized by month)` and `docs/NEXT_STEPS.md`; optionally create `docs/PLANNING/28/PHASE28/METAL_IMPLEMENTATION.md` with implementation details.
