...
**New File**: `.github/instructions/environment-setup.md`
- **Purpose**: Step-by-step guide for Windows MSVC2022 development environment setup
- **Content Coverage**:
  1. Prerequisites and system requirements (60GB space, 16GB RAM)
  2. Visual Studio BuildTools 2022 installation (with .vsconfig auto-import)
  3. CMake and Ninja installation
  4. vcpkg bootstrap and configuration
  5. Project CMake configuration (win32 preset)
  6. Build process (z_generals target)
  7. Executable deployment (GeneralsXZH.exe, GeneralsX.exe)
  8. Game asset configuration (original game Data folder symlink/copy)
  9. Running and debugging the game
  10. Troubleshooting common issues
  11. Command reference and directory structure
...
- **Key Features**:
  ...
  - Complete build system workflow from zero to running game
  - Environment variable reference table
  - Quick reference command section
  - Directory structure diagram showing vcpkg, ninja, deployment layout
