...
// Basic types - avoid conflicts by only defining what's needed
...
// Use macros instead of typedefs to avoid conflicts
...
static inline void AIL_set_stream_loop_count(HSTREAM a, S32 b) {}
