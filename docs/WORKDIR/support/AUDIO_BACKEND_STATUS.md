...
- `docs/WORKDIR/phases/3/PHASE32/AUDIO_PIPELINE_INVESTIGATION.md` - Current phase work
- `docs/WORKDIR/support/BIG_FILES_REFERENCE.md` - Asset structure (Music.big contents)
