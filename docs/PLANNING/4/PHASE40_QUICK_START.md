...
- **Total Documentation**: `docs/PLANNING/4/PHASE40/README.md` (507 lines)
...
open docs/PLANNING/4/PHASE40/INDEX.md

# Then read the main documentation
open docs/PLANNING/4/PHASE40/README.md

# Reference for session context
open docs/PLANNING/4/PHASE40/SESSION_SUMMARY.md
```
...
### Documentation
- Main guide: `docs/PLANNING/4/PHASE40/README.md`
- Overview: `docs/PLANNING/4/PHASE40/INDEX.md`
- Session notes: `docs/PLANNING/4/PHASE40/SESSION_SUMMARY.md`
...
→ Read `docs/PLANNING/4/PHASE40/README.md` now  
