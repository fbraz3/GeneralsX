...
{
	INI ini;
	AsciiString mousePath;
	mousePath.concat("Data");
	mousePath.concat(GET_PATH_SEPARATOR());
	mousePath.concat("INI");
	mousePath.concat(GET_PATH_SEPARATOR());
	mousePath.concat("Mouse");
	ini.loadFileDirectory(AsciiString(mousePath.str()), INI_LOAD_OVERWRITE, NULL);
}
