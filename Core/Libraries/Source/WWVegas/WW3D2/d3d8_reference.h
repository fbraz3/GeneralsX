...
// ========================================================================
// Forward declare the game code's expected interface names
// Our CORE_ stubs act as their implementations
using IDirect3D8 = CORE_IDirect3D8;
using IDirect3DDevice8 = CORE_IDirect3DDevice8;
using IDirect3DResource8 = CORE_IDirect3DResource8;
using IDirect3DBaseTexture8 = CORE_IDirect3DBaseTexture8;
using IDirect3DTexture8 = CORE_IDirect3DTexture8;
using IDirect3DSurface8 = CORE_IDirect3DSurface8;
using IDirect3DVertexBuffer8 = CORE_IDirect3DVertexBuffer8;
using IDirect3DIndexBuffer8 = CORE_IDirect3DIndexBuffer8;
using IDirect3DVolumeTexture8 = CORE_IDirect3DVolumeTexture8;
using IDirect3DCubeTexture8 = CORE_IDirect3DCubeTexture8;
using IDirect3DVolume8 = CORE_IDirect3DVolume8;
using IDirect3DSwapChain8 = CORE_IDirect3DSwapChain8;
