...
**[📋 Known Issues Index](docs/WORKDIR/phases/legacy/Known_Issues/README.md)**
...
2. Read platform-specific build guides ([macOS](docs/ETC/MACOS_BUILD_INSTRUCTIONS.md), [Linux](docs/ETC/LINUX_BUILD_INSTRUCTIONS.md))
