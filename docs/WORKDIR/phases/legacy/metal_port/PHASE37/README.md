...
3. **Compare with Phase 28.4 working state**:
   ...
   - See `docs/WORKDIR/28/PHASE28/CRITICAL_VFS_DISCOVERY.md`
...
- `docs/WORKDIR/28/PHASE28/CRITICAL_VFS_DISCOVERY.md` - Why VFS integration failed, why Apply_New_Surface() works
