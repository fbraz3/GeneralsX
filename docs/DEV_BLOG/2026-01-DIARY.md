...
Completed Windows local environment setup, PHASE 01 (Win32 Audit), PHASE 02 (SDL2 Entry Point), PHASE 03 Task 1 (SDL2Mouse), and PHASE 03 Task 2 (SDL2Keyboard). Windows + SDL2 focus confirmed by user.
