...
#include "ww3d.h"
#include "win.h"  // GeneralsX @build fbraz 01/04/2026 For MMRESULT/timeBeginPeriod declarations
#include "mmsys.h" // GeneralsX @bugfix BenderAI 01/04/2026 Ensure WinMM declarations on WIN32_LEAN_AND_MEAN builds
