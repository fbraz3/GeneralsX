...
- **Total Documentation**: `docs/PHASE40/README.md` (507 lines)
...
open docs/PHASE40/INDEX.md

# Then read the main documentation
open docs/PHASE40/README.md

# Reference for session context
open docs/PHASE40/SESSION_SUMMARY.md
```
...
### Documentation
- Main guide: `docs/PHASE40/README.md`
- Overview: `docs/PHASE40/INDEX.md`
- Session notes: `docs/PHASE40/SESSION_SUMMARY.md`
- Diary: `docs/MACOS_PORT_DIARY.md`
...
2. **Update the diary**:
   - Add entry to `docs/MACOS_PORT_DIARY.md`
...
→ Read `docs/PHASE40/README.md` now  
