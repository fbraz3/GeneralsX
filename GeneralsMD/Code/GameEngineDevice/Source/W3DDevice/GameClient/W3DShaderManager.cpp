...
Int ScreenBWFilter::set(FilterModes mode)
{
	...
	{	//rendering a quad with redirected rendering surface tinted by pixel shader
		...
		D3DXVECTOR4 lumaVector(0.3f, 0.59f, 0.11f, 1.0f);
		DX8Wrapper::_Get_D3D_Device8()->SetPixelShaderConstant(0, (const void*)&lumaVector, 1);
...
//			color.z = 1.0f;
		...
		D3DXVECTOR4 fadeVector(m_curFadeValue, m_curFadeValue, m_curFadeValue, 1.0f);
		DX8Wrapper::_Get_D3D_Device8()->SetPixelShaderConstant(2, (const void*)&fadeVector, 1);
