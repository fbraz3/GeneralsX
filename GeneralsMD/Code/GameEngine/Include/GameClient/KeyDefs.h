...
// DirectInput key code definitions for non-Windows platforms
#ifndef _WIN32
...
#define DIK_NUMPADPERIOD    0x53    /* . on numeric keypad (alias) */
#define DIK_NUMPADSTAR      0x37    /* * on numeric keypad (alias) */
#define DIK_NUMPADMINUS     0x4A    /* - on numeric keypad (alias) */
#define DIK_NUMPADPLUS      0x4E    /* + on numeric keypad (alias) */
#define DIK_F11             0x57
#define DIK_F12             0x58
...
#define DIK_RIGHTARROW      0xCD    /* RightArrow on arrow keypad (alias) */
#endif
