...
3. **Document upstream changes**:
   - Create `docs/PLANNING/3/PHASE36/UPSTREAM_CHANGES.md` with summary of superhackers commits
...
1. **Create conflict resolution log**:
   - `docs/PLANNING/3/PHASE36/CONFLICTS_RESOLVED.md` - List of all conflicts and how resolved
