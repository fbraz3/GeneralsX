...
3. **Document upstream changes**:
   - Create `docs/WORKDIR/phases/3/PHASE36/UPSTREAM_CHANGES.md` with summary of superhackers commits
...
4. **Documentation** (KEEP OURS):
   ...
   - `docs/DEV_BLOG/YYYY-MM-DIARY.md (organized by month)` (our work)
...
1. **Create conflict resolution log**:
   - `docs/WORKDIR/phases/3/PHASE36/CONFLICTS_RESOLVED.md` - List of all conflicts and how resolved
