...
void Shell::init(void)
{
	...
	AsciiString smsPath1, smsPath2;
	smsPath1.concat("Data");
	smsPath1.concat(GET_PATH_SEPARATOR());
	smsPath1.concat("INI");
	smsPath1.concat(GET_PATH_SEPARATOR());
	smsPath1.concat("Default");
	smsPath1.concat(GET_PATH_SEPARATOR());
	smsPath1.concat("ShellMenuScheme");
	smsPath2.concat("Data");
	smsPath2.concat(GET_PATH_SEPARATOR());
	smsPath2.concat("INI");
	smsPath2.concat(GET_PATH_SEPARATOR());
	smsPath2.concat("ShellMenuScheme");
	ini.loadFileDirectory(AsciiString(smsPath1.str()), INI_LOAD_OVERWRITE, NULL);
	ini.loadFileDirectory(AsciiString(smsPath2.str()), INI_LOAD_OVERWRITE, NULL);
