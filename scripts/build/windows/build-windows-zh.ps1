# GeneralsX modern Windows x64 build script for Zero Hour.
# GeneralsX @build BenderAI 01/04/2026 Configure and build GeneralsXZH with windows64-deploy preset.
...
Invoke-InMsvcEnv -Command "cmake --build build/$Preset --target z_generals --config RelWithDebInfo" -LogFile "logs/build_zh_windows.log"

Write-Host "Build complete: GeneralsXZH ($Preset)"
