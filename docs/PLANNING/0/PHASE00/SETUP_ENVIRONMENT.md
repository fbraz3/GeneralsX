...
1. **Read**: `docs/PLANNING/0/PHASE00/README.md` - Project overview
2. **Read**: `docs/PLANNING/0/PHASE00/CRITICAL_LESSONS.md` - Critical patterns to remember
3. **Review**: `docs/PLANNING/0/PHASE00/COMPATIBILITY_LAYERS.md` - Architecture
4. **Start**: `docs/PLANNING/0/PHASE01/README.md` - Begin PHASE01 Implementation
...
- **Project Overview**: `docs/PLANNING/0/PHASE00/README.md`
- **Troubleshooting**: `.github/instructions/project.instructions.md`
- **Asset System**: `docs/PLANNING/0/PHASE00/ASSET_SYSTEM.md`
