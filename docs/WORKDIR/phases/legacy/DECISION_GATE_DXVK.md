...
4. Daily progress tracking in `docs/DEV_BLOG/YYYY-MM-DIARY.md (organized by month)`
...
- `docs/DEV_BLOG/YYYY-MM-DIARY.md (organized by month)` - Development progress
- `docs/WORKDIR/lessons/LESSONS_LEARNED.md` - Why Phase 37 hangs
