...
void GameLODManager::init(void)
{
	...
	AsciiString gameLODPath1, gameLODPath2;
	gameLODPath1.concat("Data");
	gameLODPath1.concat(GET_PATH_SEPARATOR());
	gameLODPath1.concat("INI");
	gameLODPath1.concat(GET_PATH_SEPARATOR());
	gameLODPath1.concat("GameLOD");
	gameLODPath2.concat("Data");
	gameLODPath2.concat(GET_PATH_SEPARATOR());
	gameLODPath2.concat("INI");
	gameLODPath2.concat(GET_PATH_SEPARATOR());
	gameLODPath2.concat("GameLODPresets");
	ini.loadFileDirectory(AsciiString(gameLODPath1.str()), INI_LOAD_OVERWRITE, NULL);

	//Get presets for each known hardware configuration
	ini.loadFileDirectory(AsciiString(gameLODPath2.str()), INI_LOAD_OVERWRITE, NULL);
